[[https://github.com/Anoncheg1/emacs-cui/workflows/melpazoid/badge.svg]]
[[http://melpa.org/#/cui][file:https://melpa.org/packages/cui-badge.svg]]
[[https://github.com/Anoncheg1/emacs-cui/workflows/melpazoid-release/badge.svg]]
[[https://stable.melpa.org/#/cui][file:https://stable.melpa.org/packages/cui-badge.svg]]

* CUI - chat interface to LLMs and AI agents in Org blocks.
...
O is Org-mode, ai is AI. Don't confuse with “OpenAPI Initiative” (CUI) organization, Open Archives Initiative, Object-action interface, Shorthand for OpenAI.
...
[[https://raw.githubusercontent.com/Anoncheg1/public-share/main/cui.png]]
...
| File              | Purpose                                                            |
|-------------------+--------------------------------------------------------------------|
| cui.el            | Minor mode and ~C-c C-c~ activation of #+begin_ai                  |
| cui-restapi.el    | Connection to REST API (OpenAI-compatible)                         |
| cui-block.el      | Handling ai block                                                  |
...
~cui-restapi-con-service~ - default service symbol if not specified in header of ai block like this: ~#+begin_ai :service local~
...
or
: (advice-add 'cui-block--set-ai-keywords :override (lambda () t))
...
(add-hook 'cui-block-after-chat-insertion-hook #'my/ai-postprocess)
#+end_src
...
** Custom roles
There are ~cui-block-roles-prefixes~ variable that allow to customize roles at step of parsing ai block before sending.
