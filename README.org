...
*Version 0.3.2*
Emacs package, provide block ~#+begin_cui~ in Org mode for communication with LLMs APIs. Inspired by Robert Krahn's [[https://github.com/rksm/org-ai][org-ai package]]
...
(add-hook 'org-tab-first-hook #'cui-optional-markdown-cycle)
#+end_src

---

If you use https://github.com/Anoncheg1/emacs-indent use this:
#+begin_src elisp :lexical t :results none :exports code :eval no
(require 'cui-optional)
