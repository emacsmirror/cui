...
#+begin_cui :noweb yes :stream nil :max-tokens 1200 :sys "Be helpful."  :service github :model "openai/gpt-4.1"
<<initialization>>
#+end_ai
: -----------------------------------------------------------
...
How? We keep trace of all cui blocks that was pros a list of header markers. Do it in functions:
-`cui-block-tags-get-content-ai-messages'
